...
BEGIN
  ...
  VALUES
    ...
    ('BB LIVE Demo', 'Interactive live performance demo', 'Narrator Studio', 'p8b1357538d2', 'r8b79330a2fd', 'Hey there! Ready to talk about the blues?', 'You are BB, a blues legend, performing live.', 'Narrator', '#ffffff', '#0a0a0a', 'Experience BB LIVE', 'Interactive live performance with BB', 'Click "Start Conversation" to begin', 'Learn More', 'https://narrator.studio', 24, true, 'active', v_user_id),
